...
/* package haskulator-0.1.0.0 */
#ifndef VERSION_haskulator
#define VERSION_haskulator "0.1.0.0"
#endif /* VERSION_haskulator */
#ifndef MIN_VERSION_haskulator
#define MIN_VERSION_haskulator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskulator */
...
#define CURRENT_COMPONENT_ID "haskulator-0.1.0.0-8tf0pgbbeFlIMg3RwO1jhv-haskulator-exe"
