...
/* package haskulator-backend-0.1.0.0 */
#ifndef VERSION_haskulator_backend
#define VERSION_haskulator_backend "0.1.0.0"
#endif /* VERSION_haskulator_backend */
#ifndef MIN_VERSION_haskulator_backend
#define MIN_VERSION_haskulator_backend(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskulator_backend */
...
#define CURRENT_COMPONENT_ID "haskulator-backend-0.1.0.0-DMPf4AiOGgDLBsJeBJ1AkV-haskulator-backend-exe"
